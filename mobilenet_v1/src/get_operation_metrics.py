...
def generate_csv_file(metrics:list):
    ...
    # print(model_dir)
    if not os.path.exists("{}/metrics".format(args.model_dir)):
        os.makedirs("{}/metrics".format(args.model_dir))
    df_0.to_csv("{}/metrics/op_count_{}_partition_0.csv".format(args.model_dir, args.op_type))
    df_1.to_csv("{}/metrics/op_count_{}_partition_1.csv".format(args.model_dir, args.op_type))
    print("Wrote data to file: ", "{}/metrics/op_count_{}".format(args.model_dir,args.op_type))
